...
// Curated starter bank. Flag emoji lives only in `flag`; flagCode points at a local SVG asset.
export const BANK = [
 ...
 ['Flag','Laos','Which country is this?',[102.6,17.97],'🇱🇦','Asia','la'],['Flag','Uruguay','Which country is this?',[-56.1645,-34.9011],'🇺🇾','Americas','uy'],['Flag','Nepal','Which country is this?',[84.124,28.3949],'🇳🇵','Asia','np'],['Flag','Ghana','Which country is this?',[-1.0232,7.9465],'🇬🇭','Africa','gh'],['Flag','Estonia','Which country is this?',[25.0136,58.5953],'🇪🇪','Europe','ee'],['Flag','New Zealand','Which country is this?',[174.886,-40.9006],'🇳🇿','Oceania','nz'],
...
].map((x,i)=>({id:`q${i+1}`,category:x[0],name:x[1],prompt:x[2],coords:x[3],flag:x[4],region:x[5],flagCode:x[6]||''}));
