...
const required = [
  'index.html','styles.css','qa-fixes.css','polish.css','print.css','app.js','patch.js','qa-fixes.js','qa-data-integrity.js','coverage.js','qa-summary-stable.js','polish.js','settle.js','db.js','sw.js',
...
const settle = fs.readFileSync(path.join(root, 'settle.js'), 'utf8');
...
for (const settleToken of ['setTextQuietly','confirmed no-poop','MutationObserver','Weekly pattern review']) {
  if (!settle.includes(settleToken)) throw new Error(`Summary race stabilizer missing contract token: ${settleToken}`);
}
...
for (const asset of ['styles.css','qa-fixes.css','polish.css','print.css','app.js','patch.js','qa-fixes.js','qa-data-integrity.js','coverage.js','qa-summary-stable.js','polish.js','settle.js','manifest.webmanifest']) {
...
for (const asset of ['styles.css','qa-fixes.css','polish.css','print.css','app.js','patch.js','qa-fixes.js','qa-data-integrity.js','coverage.js','qa-summary-stable.js','polish.js','settle.js','db.js']) {
...
console.log('Glow validation passed: source coverage, playtest fixes, round-two privacy/accessibility, stable summaries, browser scenarios, persisted visual review, offline assets, and live smoke are present.');
